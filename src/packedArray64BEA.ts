const int32ToBinary = function(n: number){
...
export const unpackArray_64BEA = function*(data: view, bitDepth: number, length: number){// yields int
...
export class PackedArray_64BEA_Builder{
    ...
    bitDepth: number;
    length: number;
    constructor(bitDepth: number, length: number){
